...
> = {
  ...
  "energy-bar": { name: "에너지 바", description: "오늘의 클릭 여유를 12, 피로도를 18 회복합니다.", category: "클릭 회복형" },
  "energy-drink": { name: "고농축 에너지 드링크", description: "오늘의 클릭 여유를 24, 피로도를 35 회복합니다.", category: "클릭 회복형" },
