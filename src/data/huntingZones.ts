    ...
    monsters: [
      {
        ...
        flavor: "숲 입구를 떠도는 가장 기본적인 사냥 대상입니다.",
        maxHp: 180,
        defense: 8,
        expReward: 18,
        isBoss: false,
      ...
      },
      {
        ...
        flavor: "방어는 약하지만 주머니에서 골드를 자주 흘립니다.",
        maxHp: 260,
        defense: 14,
        expReward: 26,
        isBoss: false,
      ...
      },
      {
        ...
        flavor: "초보 숲 깊은 곳을 지키는 보스형 몬스터입니다.",
        maxHp: 340,
        defense: 18,
        expReward: 34,
        isBoss: true,
    ...
    monsters: [
      {
        ...
        flavor: "광산 천장에 숨어 있다가 강화 재료를 떨어뜨립니다.",
        maxHp: 520,
        defense: 28,
        expReward: 52,
        isBoss: false,
      ...
      },
      {
        ...
        flavor: "두꺼운 암석 껍질로 둘러싸여 오래 버팁니다.",
        maxHp: 680,
        defense: 34,
        expReward: 66,
        isBoss: false,
      ...
      },
      {
        ...
        flavor: "돌언덕 광산의 출구를 지키는 보스형 채굴 감독관입니다.",
        maxHp: 860,
        defense: 40,
        expReward: 82,
        isBoss: true,
    ...
    monsters: [
      {
        ...
        flavor: "황금 밀이 익은 들판을 떠돌며 수확 자원을 흘립니다.",
        maxHp: 2240,
        defense: 88,
        expReward: 178,
        isBoss: false,
      ...
      },
      {
        ...
        flavor: "민첩하게 움직이며 고가의 골드 주머니를 떨어뜨립니다.",
        maxHp: 2480,
        defense: 96,
        expReward: 192,
        isBoss: false,
      ...
      },
      {
        ...
        flavor: "평원의 한가운데를 지배하며 세트 장비 재료를 지킵니다.",
        maxHp: 2860,
        defense: 108,
        expReward: 220,
        isBoss: true,
    ...
    monsters: [
      {
        ...
        flavor: "공연장 주변을 떠돌며 아이돌 관련 아이템을 흘립니다.",
        maxHp: 3380,
        defense: 122,
        expReward: 256,
        isBoss: false,
      ...
      },
      {
        ...
        flavor: "무대 뒤편을 지키며 긴 전투를 강요하는 몬스터입니다.",
        maxHp: 3720,
        defense: 136,
        expReward: 274,
        isBoss: false,
      ...
      },
      {
        ...
        flavor: "별빛 무대 도시의 중심 무대를 지배하는 이벤트 보스입니다.",
        maxHp: 4280,
        defense: 152,
        expReward: 320,
        isBoss: true,
